...
- Keep orchestration concerns inside Aspire.AppHost.
- Keep service defaults inside Aspire.ServiceDefaults.
- Do not leak Aspire hosting concerns into Domain or Application.
- Model external dependencies explicitly in the AppHost.
